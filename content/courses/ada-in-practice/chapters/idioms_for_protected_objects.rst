...
1, rather than 2. The problem appears as long as preemption occurs prior to
step 3.
...
with the execution of any other thread that also accesses that shared resource.
